...
impl Site {
    ...
    /// # Arguments
    ///
    /// * `other` - The other site to merge with
    ...
    /// # Returns
    ///
    /// A JSON with the site information.
    ...
    /// # Returns
    ///
    /// The tags of the questions in the site.
    ...
    /// # Returns
    ///
    /// The ratio between the amount of words and the amount of questions in the site.
